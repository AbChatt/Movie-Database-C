 ...
 * you have to run your own tests and make sure it is so.
 * 
...
int main()
{
  ...
  ///
  ///   Passing all these tests will ensure your solution gets a solid mark
  ///   for the assignment, but the testing is not exhaustive, so passing
  ...
  // UNCOMMENT THE LINES BELOW ONLY WHEN YOUR SOLUTION IS COMPLETE AND PASSES ALL TESTS!  
